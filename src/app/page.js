...
//             <img src="icons8-favicon-94.png" className="h-8 mr-3" alt="Flowbite Logo" />
//             <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Shipment Tracker</span>
//         </a>
//         <div className="flex items-center">
//             <a href="tel:5541251234" className="mr-6 text-sm  text-gray-500 dark:text-white hover:underline">9536221459</a>
            
//             <Link className="text-sm  text-blue-600 dark:text-blue-500 hover:underline" href="/login">Login</Link>
//         </div>
//     </div>
// </nav>
      ...
      <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
          <div className="relative flex flex-col md:flex-row">
              <a href="#_" className="flex items-center mb-5 font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0">
                  <span className="mx-auto text-xl font-black leading-none text-gray-900 select-none">Shipment Tracker<span className="text-indigo-600">.</span></span>
              </a>
          ...
          <div className="inline-flex items-center ml-5 space-x-6 lg:justify-end">
              ...
              <Link className="text-base font-medium leading-6 text-gray-600 whitespace-no-wrap transition duration-150 ease-in-out hover:text-gray-900" href="/login">Login</Link>
            
              <Link className="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600" href="/register">Sign up</Link>
          </div>
      </div>
  </section>
        ...
        <div className="w-full md:w-1/2 md:px-3">
          <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
              ...
              <span className="block text-indigo-600 xl:inline">Help You to Ship your products Faster.</span>
            </h1>
            <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">It's never been easier to all instruments to track and manage all the shipments and users.</p>
